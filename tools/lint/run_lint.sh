...
gate_command() {
    case "$1" in
        ...
        check-shell-host-assumptions)      echo './tools/lint/check_shell_host_assumptions.sh --selftest && ./tools/scripts/port_probe.sh --selftest && ./tools/scripts/isolated_node_env_selftest.sh && ./tools/scripts/isolated_mainnet_env_selftest.sh && ./tools/scripts/service_args_selftest.sh && bash tools/scripts/two_node_peer_tip_selftest.sh && ./tools/lint/check_shell_host_assumptions.sh' ;;
